...
extern GPS myData;
float vitmax=0.0;
extern COMPTEUR statecpt;//etat de lka sous machine a etat finis utilisé pour le compte a rebour
extern DISTANCEVILLE statedistanceville;
extern int boumheure;
extern int boumminutes;
extern int choose;

VILLE_t paris={{'p','a','r','i','s'}, 48.8534951, 2.3483915};
VILLE_t ensea={{'e','n','s','e','a'}, 49.0395063, 2.0724911};
