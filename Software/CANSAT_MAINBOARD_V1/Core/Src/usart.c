...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END LPUART1_MspDeInit 0 */
    ...
    PB11     ------> LPUART1_TX
    */
    HAL_GPIO_DeInit(LPUART1_RX_TRANSMITTER_GPIO_Port, LPUART1_RX_TRANSMITTER_Pin);

    HAL_GPIO_DeInit(LPUART1_TX_TRANSMITTER_GPIO_Port, LPUART1_TX_TRANSMITTER_Pin);
