...
//		vtemp=(float) ((vrefint*rawdata[1])/4095.0);
		...
		vbat=(float) 2*(rawADCdata[4]/4095.0)*vrefint;
		current=(float) 2 * 60 *(rawADCdata[3]/4095.0)*vrefint;
		power=(float) vbat*current;
		vexternalsensor=(float) 2*(rawADCdata[2]/4095.0)*vrefint;
